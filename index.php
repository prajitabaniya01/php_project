...
<body>
    ...
    <header class="header">
        <a href="#" class="logo">
            <img src="assets/images/logo-min.avif" class="img-logo" alt="Logo">
        </a>
    ...
    <section class="about" id="about">
        ...
        <div class="row g-0">
            <div class="image">
                <img src="https://wallpapers.com/images/hd/beige-aesthetic-coffee-latte-and-cookies-d9lxa8um7teluut8.jpg"
                    alt="" class="img-fluid">
            </div>
            <div class="content">
                <h3>Welcome!</h3>
                <p>
                    At to Coffee Shop, we are passionate about coffee and believe
                ...
                <p>
                    ...
                    inviting atmosphere is designed to be a haven
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <p>All our tea and coffee is carbon neutral – but what does that actually mean? Here’s
                                    an explanation of how we’ve lowered our carbon footprint...</p>
                                <center>
                                    <a href="https://www.taylorsofharrogate.co.uk/news/carbon-neutral-tea-and-coffee"
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            <iframe style="width:50%;"
                src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d56515.753963463765!2d85.2457094!3d27.7100413!3m2!1i1024!2i768!4f13.1!2m1!1shimalaya%20java!5e0!3m2!1sen!2snp!4v1707568846845!5m2!1sen!2snp"
                width="50" height="525" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <div class="chat-bar-collapsible">
        <button id="chat-button" type="button" class="collapsible">Chat with us! &nbsp;
            <i id="chat-icon" style="color: #2c1a07;" class="fas fa-comments"></i>
        </button>
        <div class="content">
